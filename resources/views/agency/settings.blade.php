    ...
    <div class="panel-container show"><div class="panel-content">
        <form method="post" action="<?= e(url('settings')) ?>" enctype="multipart/form-data" class="invoice-profile-form">
            ...
            <div class="row">
                ...
                <div class="col-md-4"><div class="form-group"><label class="required" for="invoice_ocn_bin">Number (OCN/BIN)</label><input class="form-control" id="invoice_ocn_bin" name="ocn_bin" required value="<?= e($invoiceProfile['ocn_bin']??'') ?>" placeholder="Enter OCN or BIN"></div></div>
